        ...
        <div className="event">
            <div className="abstract">
                ...
                <div className="info">
                    ...
                    <div className="subtitle">{eventData.subtitle}</div>
                    <div className="date">Date: {eventData.date}</div>
                    <div className="numberOfOpening">Number of Opening: {eventData.numberOfOpening}</div>
                    <div className="host">Host: {eventData.host}</div>
                    <div className="apply"><button className="applyBtn" onClick={applyAction}>Apply</button></div>
                </div>
            </div>
            <hr></hr>
